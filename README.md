# Ansible Role: Ansible Semaphore Bootstrap

An ansible role to bootstrap [Ansible Semaphore](https://github.com/ansible-semaphore/semaphore)

This role is used as part of a shell script to bootstrap ansible and semaphore. It handles the setup and installation of required dependencies.
...
- `semaphore_ansible_cfg_vault_password_file`: location of vault password file.
  - Default: `{{ semaphore_config_data_dir }}/.vpf`
...
- hosts: all
  vars:
    semaphore_db_admin_password: 'DBr00tpa55w0rd'
    semaphore_db_auth_password: 'DB4uthPa55word'
  ...
  roles:
    - thedumbtechguy.semaphore-bootstrap
```
